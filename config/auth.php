...
return [
    'auth_on' => 1, // 权限开关
    'auth_type' => 1, // 权限认证方式，1为实时认证；2为登录认证-缓存。
    'role' => 'sys_role', // 用户组数据表名, 不包含database.prefix
    'user_role' => 'sys_user_role', // 用户-用户组关系表, 不包含database.prefix
    'role_menu' => 'sys_role_menu', // 角色-权限关系表, 不包含database.prefix
    'menu' => 'sys_menu', // 权限规则表, 不包含database.prefix
    'user' => 'sys_user', // 用户信息表, 不包含database.prefix; 用于字段condition时，对值的判断
];