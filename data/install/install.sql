...
INSERT INTO `cms_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,belongto) VALUES (721, 72, '审核评论', 'admin/Article/auditComment', '', 1, 0, 1, 1,'','admin');
