...
#内容管理
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (7, 0, '内容管理', 'admin/ShowNav/Cms', 'fa-file-text', 1, 1, 11, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (71, 7, '文章管理', 'admin/Article/index', '', 1, 1, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (711, 71, '查看文章', 'admin/Article/viewArticle', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (712, 71, '新增文章', 'admin/Article/addArticle', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (713, 71, '编辑文章', 'admin/Article/editArticle', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (714, 71, '删除文章', 'admin/Article/deleteArticle', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (715, 71, '置顶', 'admin/Article/setTop', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (716, 71, '取消置顶', 'admin/Article/unsetTop', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (717, 71, '发布文章', 'admin/Article/postArticle', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (7171, 71, '初审', 'admin/Article/auditFirst', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (7172, 71, '终审', 'admin/Article/auditSecond', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (7173, 71, '定时发布', 'admin/Article/setTimingPost', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (7174, 71, '文章访问统计', 'admin/Article/articleStat', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (7175, 71, '文章访问量统计图', 'admin/Article/echartShow', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (7176, 71, '批量修改分类', 'admin/Article/batchCategory', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (72, 7, '评论管理', 'admin/Article/commentList', '', 1, 1, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (721, 72, '审核评论', 'admin/Article/auditComment', '', 1, 1, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (722, 72, '回发评论', 'admin/Article/postComment', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (723, 72, '删除评论', 'admin/Article/deleteComment', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (724, 72, '查看评论', 'admin/Article/viewComments', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (73, 7, '文章分类', 'admin/Article/categoryList', '', 1, 1, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (731, 73, '新增分类', 'admin/Article/addCategory', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (732, 73, '编辑分类', 'admin/Article/editCategory', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (733, 73, '排序分类', 'admin/Article/orderCategory', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (734, 73, '删除分类', 'admin/Article/deleteCategory', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (74, 7, '广告管理', 'admin/Article/adList', '', 1, 1, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (741, 74, '新增广告', 'admin/Article/addAd', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (742, 74, '编辑广告', 'admin/Article/editAd', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (743, 74, '广告排序', 'admin/Article/orderAd', '', 1, 0, 1, 1,'','admin');
INSERT INTO `sys_auth_rule`(id,pid,title,name,icon,type,is_menu,sort,status,`condition`,beyongs_to) VALUES (744, 74, '删除广告', 'admin/Article/deleteAd', '', 1, 0, 1, 1,'','admin');
